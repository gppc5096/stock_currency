...
class StockMonitorApp(QMainWindow):
    ...
    def initUI(self):
        ...
        # 타이틀 라벨 추가
        title_label = QLabel('USA 미국주식 현재주가 현황', self)
    ...
    def update_index_data(self):
        ...
        self.index_animation.setDuration(10000)  # 애니메이션 속도 조절 (10,000ms = 10초)
    ...
    def apply_styles(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton:hover {
                background-color: #7ad6b4;  /* 마우스를 버튼 위에 올렸을 때 배경색을 검정으로 설정 */
